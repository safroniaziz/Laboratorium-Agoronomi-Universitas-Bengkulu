                    ...
                    <div class="box-body">
                        <div class="row" style="margin-bottom:10px !important;">
                            <div class="col-md-12" style="margin-bottom:10px !important;">
                                <a href="{{ route('mahasiswa.dashboard') }}" class="btn btn-warning btn-sm btn-flat" name="submit"><i class="fa fa-arrow-left"></i>&nbsp; Kembali</a>
                            </div>
                            <div class="col-md-12">
                                <div class="alert alert-danger"><i class="fa fa-info-circle"></i>&nbsp;Harap pilih jadwal praktikum terlebih dahulu</div>
                            </div>
                            <form action="{{ route('mahasiswa.cari_detail',[$matkul->id]) }}" method="GET">
                        ...
                        @if (isset($_GET['sesi_id']))
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="#"><i class="fa fa-check"></i>
                                    ...
                                    @if ($sesi->jumlah_peserta > $sesi->pesertas()->count() && empty($terdaftar))
                                        <form action="{{ route('mahasiswa.daftar',[$sesi->id,$matkul->id]) }}" method="post">
