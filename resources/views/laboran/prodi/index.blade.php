    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-building-o"></i>&nbsp;Manajemen Data Program Studi</h3>
                <div class="pull-right">
                    <a href="{{ route('laboran.prodi.add') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp; Tambah Data Prodi</a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                                    ...
                                    <td> {{ $prodi->kode_prodi }} </td>
                                          <td style="display:inline-block !important;">
                                            <table>
                                                <tr>
                                                    <td>
                                                       <a href="{{ route('laboran.prodi.edit',[$prodi->id]) }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a>


                                                    </td>
                                                    <td>

                                                       <form action="{{ route('laboran.prodi.delete',[$prodi->id]) }}" method="POST">
            ...
            {{--  <div class="modal fade modal-danger" id="modaldelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action=" {{ route('laboran.prodi.delete',[$indikator->id]) }}" method="POST">
                            {{ csrf_field() }} {{ method_field('DELETE') }}
