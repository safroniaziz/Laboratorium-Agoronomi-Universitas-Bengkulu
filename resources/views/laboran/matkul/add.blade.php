    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-book"></i>&nbsp;Tambah Data Mata Kuliah</h3>
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <form action="{{ route('laboran.matkul.post') }}" enctype="multipart/form-data" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }} {{ method_field('POST') }}
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="sks_praktikum" class="form-control" >
                                <div>
